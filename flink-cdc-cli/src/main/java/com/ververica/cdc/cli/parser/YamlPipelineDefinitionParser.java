...
public class YamlPipelineDefinitionParser implements PipelineDefinitionParser {
    ...
    public PipelineDef parse(Path pipelineDefPath, Configuration globalPipelineConfig)
        ...
        return parse(root, globalPipelineConfig);
    }

    @Override
    public PipelineDef parse(InputStream inputStream, Configuration globalPipelineConfig)
            throws Exception {
    ...
    @Override
    public PipelineDef parse(JsonNode root, Configuration globalPipelineConfig){
        // Source is required
        SourceDef sourceDef =
                toSourceDef(
                        checkNotNull(
